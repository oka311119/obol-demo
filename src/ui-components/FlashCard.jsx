  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Likeda")}
      >
        <Flex
          gap="9px"
          direction="row"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "User Likedd")}
        >
          <MyIcon
            width="24px"
            height="24px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Bodya")}
      >
        <Flex
          gap="32px"
          direction="column"
        ...
        >
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Question36553311")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Question"
              {...getOverrideProps(overrides, "Question29766887")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Answer36553315")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Answer"
              {...getOverrideProps(overrides, "Answer36553316")}
            ></Text>
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Imagesa")}
      >
        <Image
          width="100px"
          height="100px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Shared")}
      >
        <Flex
          gap="16px"
          direction="row"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Share3")}
        >
          <View
            width="24px"
            height="24px"
            {...getOverrideProps(overrides, "thumb_down")}
          ></View>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Repost2")}
        >
          <View
            width="24px"
            height="24px"
            {...getOverrideProps(overrides, "thumb_up")}
          ></View>
          <Text
            fontFamily="Inter"
            fontSize="16px"
